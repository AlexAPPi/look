...
{    
    ...
    public static $standartSpecTypes = [
        ...
        // Array
        self::TIntegerArray => \LookPhp\Type\IntegerArray::class,
        self::TDoubleArray  => \LookPhp\Type\DoubleArray::class,
        self::TNumericArray => \LookPhp\Type\NumericArray::class,

        // Unsigned array
        self::TUnsignedIntegerArray => \LookPhp\Type\UnsignedIntegerArray::class,
        self::TUnsignedDoubleArray  => \LookPhp\Type\UnsignedDoubleArray::class,
        self::TUnsignedNumericArray => \LookPhp\Type\UnsignedNumericArray::class,

        // Unsigned scalar
        self::TUnsignedInteger => \LookPhp\Type\UnsignedInteger::class,
        self::TUnsignedDouble  => \LookPhp\Type\UnsignedDouble::class,
        self::TUnsignedNumeric => \LookPhp\Type\UnsignedNumeric::class,
    ];
