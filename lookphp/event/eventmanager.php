...
use LookPhp\Event\Event;
use LookPhp\Event\EventSelector;
use LookPhp\Event\Exceptions\EventManagerException;

use LookPhp\Event\Task\EventTask;

use LookPhp\Event\Interfaces\IEventBreak;
use LookPhp\Event\Interfaces\IEventArgReplace;
use LookPhp\Event\Interfaces\IEventResultReplace;
...
class EventManager
{
     ...
     * 
     * @param \LookPhp\ExceptionEvent $event    -> Событие
     ...
     * @return \LookPhp\Event\EventResult
     */
