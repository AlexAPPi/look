...
use LookPhp\Url\Currect as UrlCurrect;
use LookPhp\Url\Builder as UrlBuilder;

use LookPhp\Pagination\ISectionable as ISectionableInterface;

use Exception;
use LookPhp\Page\Head;
use LookPhp\Page\Navigation;
use LookPhp\Page\Exceptions\PageEmptyException;
use LookPhp\Page\Exceptions\PageNotFoundException;
use LookPhp\Page\Exceptions\Page301RedirectException;
...
trait Paginatable
{
    ...
    /** @var \LookPhp\Url\Builder объект ссылки c убранной секцией пагинации */
    ...
    /** @var \LookPhp\Pagination\ISectionable|array Массив с элементами */
     ...
     * @return \LookPhp\Url\Builder
     */
    public function getPaginationFixUrl() : \LookPhp\Url\Builder
    {
