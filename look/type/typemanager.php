        ...
        if($param->hasType()) {
            ...
            if($paramBuiltin) {
                ...
                if($param->isVariadic()) {
                    ...
                    throw new CodeStandartException("Стандарт Look Code обработки не позволяет использовать тип [$type] c variadic методом передачи параметра");
                }
            ...
            throw new CodeStandartException("Стандарт Look Code обработки не позволяет использовать тип [$type]");
        }
