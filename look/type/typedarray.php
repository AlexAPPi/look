...
use Look\Type\CArray;
use Look\Type\Converter;
use Look\Type\Exceptions\ArrayTypedException;

/**
 * Реализует работу по сборке массива определенного типа
 * Для реализации работы типизироанных массиов,<br>
 * нужно указать в const класса типы данных из класса <b>\Look\Type\Converter::T*</b><br>
 * 
 ...
 * const <b>ItemType</b> = \Look\Type\Converter::TUnsignedInteger;<br>
 * const <b>EvalType</b> = \Look\Type\Converter::TUnsignedIntegerArray;<br>
 * 
 * Например для создания массива типа из определенного типа класса A<br><br>
 * const <b>ItemType</b> = \A::class<br>
 * const <b>EvalType</b> = \A::class . ' ' . \Look\Type\Converter::TArray<br>
 *
